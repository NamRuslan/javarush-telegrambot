...
abstract class AbstractCommandTest {
    ...
    protected JavaRushTelegramBot jrBot = Mockito.mock(JavaRushTelegramBot.class);
    protected SendBotMessageService sendBotMessageService = new SendBotMessageServiceImpl(jrBot);
